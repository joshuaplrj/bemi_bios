...
- **v7.1 Zero-Footprint Dominance**: 84 virtual threads, 784 ROB entries from the same SRAM budget, L0 shadow caches, DBO software fusion/prefetching, and 2.46x average speedup with +0.0% silicon overhead at 85W TDP.
- **v7.2 Zero-Footprint Singularity**: 144 virtual threads, 1568 main + 65,536 extended 2-byte ROB entries, full L2/L3 repurposing, a 512 MB DRAM pseudo-L4, and 17.10x average speedup with +0.0% silicon overhead at 85W TDP.
