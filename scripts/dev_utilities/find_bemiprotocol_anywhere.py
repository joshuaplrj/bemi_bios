        ...
        with open(log_path, 'r', encoding='utf-8', errors='ignore') as f:
            for idx, line in enumerate(f):
                if "bemiprotocol" in line.lower():
                    ...
                    # check if the content contains a file view or write of BemiProtocol.h
...
for i, inst in enumerate(found):
    print(f"  {i}: Conv: {inst['conv']} | Step: {inst['step']} | Type: {inst['type']}")
    # print the line or snippet
    print(f"    Snippet: {inst['line'][:300]}")
